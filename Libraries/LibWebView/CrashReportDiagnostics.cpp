...
// Older builds wrote the signal as one "SIGSEGV (11)" value. Reports saved before the split are
// still on disk after an upgrade, so both shapes reach this parser.
