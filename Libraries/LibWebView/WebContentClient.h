...
private:
    ...
    virtual void did_show_notification(u64 page_id, Web::NotificationsAPI::PlatformNotification) override;
    virtual void did_close_notification(u64 page_id, u64 notification_id) override;
